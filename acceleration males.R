...
for (m in c(1958,1959,1961:1973)) { #1966
  ...
  par(mfrow=c(1,3))
  plot(y,hG1,main=paste0("Hazard function Slope Males ",m-65),xlab="x",ylab="h'(x)",col=1,type = 'l')
  lines(y,hP1, col=2)
  abline(v=N,lty=2)
  abline(v=x_A,lty=2)
  abline(v=maxL,lty=2)
  ...
  legend(N,hP1[length(hP1)],c("Gompertz","GPD"), col=1:2,lty=1)
  
  
  plot(y1,hG,main=paste0("Hazard function Males ",m-65),xlab="x",ylab="h(x)",col=1,type = 'l')
  lines(y,hP, col=2)
  abline(v=N,lty=2)
  abline(v=x_A,lty=2)
  abline(v=x_B,lty=2)
  ...
  mtext(expression(N + theta/kappa),side = 1,at = maxL)
  legend(65,hP[length(hP)],c("Gompertz","GPD"), col=1:2,lty=1)
  
  
  plot(y1,FG,main=paste0("CDF Males ",m-65),xlab="x",ylab="F(x)",col=1,type = 'l')
  lines(y,FP, col=2)
  abline(v=N,lty=2)
  abline(v=x_A,lty=2)
  abline(v=x_B,lty=2)
